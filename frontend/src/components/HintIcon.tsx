...
const HintIcon: React.FC<HintIconProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="flex items-center cursor-pointer border-2 rounded-xl pl-4 pr-4 text-gray-700 focus:outline-none focus:ring-2 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800 transition duration-200 transform hover:scale-105"
      aria-label="Get a hint"
    >
      <span className="pr-3"><strong>Hint</strong></span>
